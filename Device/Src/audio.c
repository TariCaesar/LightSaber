...
static int32_t audioStartSector[] = {1, 50, 65, 78};
//audio length in Sectors
static int32_t audioLen[] = {49, 15, 13, 22};
...
static volatile int32_t audioBufferPingOrPong = 0;
static volatile int32_t audioBufferReadCnt = 0;
static volatile int32_t audioBufferReadNum = 0;
static volatile int32_t audioBufferAddrReadNext = 0;

static void (*audioPlayCallbackHandler)(void) = 0;
static volatile int32_t audioIsPlaying = 0;
